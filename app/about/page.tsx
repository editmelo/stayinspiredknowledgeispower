    ...
    <>
      <PageHero
        ...
        title={
          <>
            Motivated to
            <br />
            {/* Keeps "the" up with "change" so the line breaks before "stigma"
                — at this line-height the g descender met the i of stigma. */}
            <span className="nowrap">change the</span> stigma.
          </>
        }
        wave="calm"
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="prose-body lg:col-span-7">
              ...
              <div className="mt-7 space-y-4">
                <p>
                  {org.name} is motivated and inspired to change the stigma of
                  mental health and addiction through fashion, art and design.
                  It sells shirts, aprons, tumblers and bracelets, speaks in
                  schools, publishes education on substance use, points people
                  toward real help, and funds a scholarship.
                </p>
                <p>
                  Those five things are one thing. A shirt gets someone to ask a
                  question. A talk gives a room the language to answer it. A
                  resource list gives a family a phone number. And a scholarship
                  makes sure a student who grew up in the middle of all of it
                  still gets to finish school.
                </p>
              </div>
        ...
        <div className="shell band">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Reveal className="prose-body mt-10 text-left" delay={200}>
              <p>
                Miriam lost her father due to mental health and substance use.
                The {scholarship.name} carries his name, and it exists for a
                specific student: the one whose parent lives with a mental
                illness or a substance use disorder, and who is trying to get
                through school anyway.
              </p>
              <p>
                The award is ${scholarship.award}. One student has been funded
                so far. Every product sold moves the next one closer, which is
                why the merch and the scholarship are not two separate things on
                this site.
              </p>
            </Reveal>
              ...
              <Reveal className="mt-10" delay={120}>
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                  {william.grid.map((ph) => (
                    <div
                      key={ph.src}
                      className="relative aspect-square overflow-hidden bg-slate"
                    >
                      <Image
                        src={ph.src}
                        alt={ph.alt}
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="mt-6 max-w-xl text-bone/80">
                The verse on the seal is where the company name comes from.
                Knowledge is the thing that turns a private crisis into
                something a family can act on — which is the whole point of the
                education and the resources on this site.
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="shell band">
          ...
          <h2 className="display d2 mt-4 max-w-2xl">
            Five front doors, one mission
          </h2>
          <ul className="mt-12">
            {buckets.map((b, i) => (
              <Reveal as="li" key={b.href} delay={i * 60}>
                ...
                >
                  ...
                  <p className="muted text-sm md:col-span-5 md:pt-1">
                    {b.blurb}
                  </p>
                  <span
