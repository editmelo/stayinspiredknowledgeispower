...
6. **William.** Corrected 26 Aug 2026: William Rivera was Miriam's **father**, not her son, and she lost him to mental health and substance use. An earlier draft had this wrong in five places. Miriam should still read the passages on `/about` and `/scholarship` and approve the wording herself, since they describe her family. No quotations are attributed to her anywhere on the site.

   Still open from the same correction: the meeting notes described the *How Addiction Happens* video as "created by a mother who lost her son to substance use." It is now unclear whether that described Miriam or a third party whose video she shares, so the site describes what the video covers and claims no authorship. Confirm who made it.
